...
function ProductList({ onHomeClick }) {
  ...
  /**
   * Handles the click event for the home link.
   */
  ...
  /**
   * Handles the click event for the About Us link.
   */
  ...
  /**
   * Handles the click event for adding to the cart.
   */
                  ...
                  <div key={plantIndex} className="product-card">
                    ...
                    <button
                      className={`product-button ${
                        cart.find(({ name }) => name === plant.name)
                          ? "added-to-cart"
                          : ""
                      }`}
                      onClick={() => handleAddToCart(plant)}
                      disabled={cart.find(({ name }) => name === plant.name)}
                    >
                      {cart.find(({ name }) => name === plant.name)
                        ? "Added"
                        : "Add to Cart"}
